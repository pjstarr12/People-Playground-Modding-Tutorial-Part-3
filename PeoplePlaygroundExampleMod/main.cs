...
ModAPI.Register(
    new Modification()
    {
        ...
        NameOverride = "ExampleKnife",
        DescriptionOverride = "ExampleDescription",
        CategoryOverride = ModAPI.FindCategory("Melee"),
        ThumbnailOverride = ModAPI.LoadSprite("ExampleKnifeThumb.png"),
        AfterSpawn = (Instance) =>
        { 
            Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("ExampleKnife.png");
            Instance.FixColliders();
        }  
    }
);
